...
int create_socket(char *, const char *, int *, char *, struct addrinfo *);
...
int create_tcp_server(int *sockfd, const char *port, struct addrinfo *ainfo);
...
int receive_stuff(char *, int, struct addrinfo *ainfo);
